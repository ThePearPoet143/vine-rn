...
const alertStyles: Record<AlertType, { container: string; title: string; text: string; icon: string; iconColor: string }> = {
  success: {
    container: 'bg-ios-green/10 dark:bg-ios-green-dark/20',
    title: 'text-ios-green dark:text-ios-green-dark',
  ...
  warning: {
    ...
    title: 'text-ios-orange dark:text-ios-orange-dark',
    text: 'text-ios-secondary-label dark:text-ios-secondary-label-dark',
  ...
  error: {
    ...
    title: 'text-ios-red dark:text-ios-red-dark',
    text: 'text-ios-secondary-label dark:text-ios-secondary-label-dark',
  ...
  info: {
    ...
    title: 'text-ios-blue dark:text-ios-blue-dark',
    text: 'text-ios-secondary-label dark:text-ios-secondary-label-dark',
    ...
    <View className={`${styles.container} p-ios-md rounded-ios-lg ${className}`} {...props}>
      <View className="flex-row items-start gap-ios-sm">
        ...
        <View className="flex-1">
          {title && (
            <Text className={`${styles.title} text-ios-headline mb-1`}>{title}</Text>
          )}
          <Text className={`${styles.text} text-ios-subheadline`}>{children}</Text>
        </View>
      </View>
    </View>
  );
